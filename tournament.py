...
def main():
    ...
    test_agents = [
        Agent(AlphaBetaPlayer(it_dp=True, score_fn=improved_score), "AB_Improved"),
        Agent(AlphaBetaPlayer(it_dp=True, score_fn=custom_score), "AB_Custom"),
        Agent(AlphaBetaPlayer(it_dp=True, score_fn=custom_score_2), "AB_Custom_2"),
        Agent(AlphaBetaPlayer(it_dp=True, score_fn=custom_score_3), "AB_Custom_3")
    ]
    ...
    cpu_agents = [
        ...
        Agent(AlphaBetaPlayer(it_dp=True, score_fn=improved_score), "IDAB_Improved")
    ]
